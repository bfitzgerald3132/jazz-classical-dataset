...
Given a list of YouTube links to jazz and classical audio samples, this script downloads a dataset of five-second WAV files for training an audio classifier
